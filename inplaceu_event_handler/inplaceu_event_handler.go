...
var _ handler.TypedEventHandler[client.Object] = &PodEventHandler{}
...
func (e *PodEventHandler) Create(ctx context.Context, evt event.TypedCreateEvent[client.Object], q workqueue.RateLimitingInterface) {
	// 类型断言从 client.Object 到 *corev1.Pod
	...
	if pod.DeletionTimestamp != nil {
		...
		e.Delete(ctx, event.TypedDeleteEvent[client.Object]{Object: evt.Object}, q)
		return
	}
	...
	if controllerRef := metav1.GetControllerOf(pod); controllerRef != nil {
		...
		isSatisfied, _, _ := inplaceutils.ScaleExpectations.SatisfiedExpectations(req.String())
		inplaceutils.ScaleExpectations.ObserveScale(req.String(), expectations.Create, pod.Name)
		if isSatisfied {
...
func (e *PodEventHandler) Update(ctx context.Context, evt event.TypedUpdateEvent[client.Object], q workqueue.RateLimitingInterface) {
	oldPod, ok := evt.ObjectOld.(*v1.Pod)
	if !ok {
		return
	}
	curPod, ok := evt.ObjectNew.(*v1.Pod)
	if !ok {
		return
	}
	...
	if curPod.DeletionTimestamp != nil {
		...
		e.Delete(ctx, event.TypedDeleteEvent[client.Object]{Object: evt.ObjectNew}, q)
		if labelChanged {
			// we don't need to check the oldPod.DeletionTimestamp because DeletionTimestamp cannot be unset.
			e.Delete(ctx, event.TypedDeleteEvent[client.Object]{Object: evt.ObjectOld}, q)
		}
		return
	}
...
func (e *PodEventHandler) Delete(ctx context.Context, evt event.TypedDeleteEvent[client.Object], q workqueue.RateLimitingInterface) {
	...
	inplaceutils.ResourceVersionExpectations.Delete(pod)
	...
	inplaceutils.ScaleExpectations.ObserveScale(req.String(), expectations.Delete, pod.Name)
	q.Add(*req)
}
...
func resolveControllerRef(namespace string, controllerRef *metav1.OwnerReference) *reconcile.Request {
	...
	if controllerRef.Kind == inplaceutils.ControllerKind.Kind && refGV.Group == inplaceutils.ControllerKind.Group {
